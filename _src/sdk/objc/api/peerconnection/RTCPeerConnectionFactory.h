...
/** Initialize a generic RTCAudioSource that can receive manually captured audio frames.
 * This audio source should be used with RTCAudioCapturer to push audio samples
 * directly to the WebRTC audio pipeline.
 */
